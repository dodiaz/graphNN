...
path = 'Poisson_s'+str(s)+'_m'+ str(m)+'_radius'+ str(radius_train)
path_model = 'model/'+ path
path_train_err = 'results/'+ path + 'train_poisson.txt'
path_test_err = 'results/'+ path + 'test_poisson.txt'
...
for ep in range(epochs):
    ...
    if ep == 2 or ep == 10 or ep == 20 or ep == 30 or ep == 40 or ep == 50 or ep == 60 or ep == 70 or ep == 100:
        path = 'Poisson_s'+str(s)+'_m'+ str(m)+'_radius'+ str(radius_train) + '_epoch' + str(ep)
        path_model = 'model/'+ path
        path_train_err = 'results/'+ path + 'train_poisson.txt'
        path_test_err = 'results/'+ path + 'test_poisson.txt'
        path_image = 'results/'+ path
...
plt.show()
plt.savefig('results/picture_smoothcoeff_only.png')