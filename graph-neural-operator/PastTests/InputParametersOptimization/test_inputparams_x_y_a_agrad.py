...
path_train_err = 'results/'+ path + 'train1.txt'                                      ################### changed this
path_test_err = 'results/'+ path + 'test1.txt'                                        ################### chagned this
...
plt.show()
plt.savefig('results/picture_coeff_only.png')     #################### changed this